...
TECNOLOGIA CORPORATIVA ESTRATÉGICA

</div>

<h1 className="text-5xl md:text-7xl font-heading font-extrabold leading-[1.1] text-white mb-6">

Engenharia de Software para <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-400">Escala Global.</span>

</h1>

<p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-xl leading-relaxed">

Desenvolvemos infraestruturas robustas, prestamos consultoria técnica avançada e aceleramos o seu crescimento através de estratégias digitais baseadas em dados.
